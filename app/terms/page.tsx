...
export const metadata: Metadata = {
  ...
  description: 'Terms governing use of the Crawe website.'
};
  ...
  return (
    <article className="static-page">
      ...
      <div className="prose narrow">
        ...
        <p>Crawe publishes essays, commentary and other editorial material for general informational and cultural purposes. Nothing on this site should be treated as professional legal, medical, financial or other regulated advice unless explicitly stated otherwise.</p>
        <h2>Intellectual property</h2>
        <p>Unless a page states otherwise, Crawe and its contributors retain the rights in text, design, illustrations, photography and other original material. Limited quotation, linking and other uses permitted by applicable law remain unaffected.</p>
        ...
        <p>Links to external sites are provided for reference. Crawe does not control those sites and is not responsible for their content, security or privacy practices.</p>
        <h2>Donations</h2>
