...
export const metadata: Metadata = {
  ...
  description: 'How Crawe handles reader data, subscriptions and privacy.'
};
  ...
  return (
    <article className="static-page">
      ...
      <div className="prose narrow">
        ...
        <p>Crawe uses Vercel for hosting, security and first-party web analytics. We do not add Google Analytics, Meta Pixel or comparable third-party advertising analytics. We configure the site to avoid sending article body text, email addresses or admin routes as custom analytics events.</p>
        <h2>Cookies and local storage</h2>
        <p>The public reading experience does not rely on Crawe advertising or tracking cookies. Your selected visual theme is stored locally in your browser. The private editorial admin area uses a strictly necessary session cookie for authentication.</p>
        ...
        <h2>Your rights</h2>
        <p>Depending on where you live, you may have rights to access, correct, delete, restrict or object to processing, withdraw consent, receive a portable copy of certain data, or appeal a privacy decision. Residents covered by applicable US state privacy laws may also have rights concerning access, deletion and correction. Crawe does not sell personal information or share it for cross-context behavioural advertising.</p>
        <h2>International processing</h2>
        <p>Infrastructure providers may process data in multiple countries. Where legally required, appropriate transfer mechanisms and contractual safeguards should be maintained by the relevant service provider and by Crawe.</p>
        <h2>Children</h2>
